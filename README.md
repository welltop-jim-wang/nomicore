...
Nomicore 当前可作为 Cordis 插件链挂载：Clock → Timer → Memory/File Persistence → Namespace Registry。第三方宿主的完整装配示例、配置表、数据读写和停止顺序见[第三方 Cordis 宿主接入指南](docs/integration/cordis-plugin-hosting.md)。
