...
| 21 | 16:41 | SA6 | Phase 3 回流红灯 | (pending) | SA4 回流：F1 hub 侧溢出红灯 + F2 重连超时红灯 + F3 配套 seam 序列记账修复（先行锚定，SA3 对红灯实现） |
| 22 | 16:41 | SA1 | Phase 3 勘误 | (pending) | SA4 F8：§21 ALLOW LIST 补根 package.json（P-12 勘误）+ F6/F9 登记切片 7/9（与 SA6 并行） |
