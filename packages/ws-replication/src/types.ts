...
/**
 * 结构化 observer seam 事件（ADR 0010 L167 最小观测面全量映射；26 型，append-only——
 ...
 * issue #245 追加第 24–26 型 chunked-update-sent/applied/acked——ADR 0013 L89–91 域键集逐字 +
 * §23 side 信封；改道裁决（SA8 R21）：分块 transfer 的成功结算从普通族改道至 chunked 族）。
 *
