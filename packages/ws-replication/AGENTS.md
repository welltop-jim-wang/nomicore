...
This package implements the Hub/Peer connection and namespace state machines over `@nomicore/replication-protocol`. Read ADR 0010 and `docs/protocols/instance-replication-v1.md` before changing wire behavior, authentication, lifecycle, backpressure, or reconciliation.
